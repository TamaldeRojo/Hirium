...
function OwnerSignUp() {
  ...
  return (
    ...
    <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-[#251B37] lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    <img src="https://i.pinimg.com/564x/e2/21/24/e221244607cec016164c39c1b4e9ba69.jpg" width={150} className="rounded-full" />
                ...
                <div
                    ...
                    style={{
                        background: "linear-gradient(152.92deg, rgba(19, 32, 67, 0.2) 4.54% rgba(253, 240, 240, 0.1) 77.55%)", filter: "blur(118px)"
                    }}
                >
                    ...
                    >
                        <div>
                            ...
                            <input
                                type="text"
                                required
                                className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-[#372948] shadow-sm rounded-lg"
                        ...
                        <button
                            className="w-full px-4 py-2 text-white font-medium bg-[#372948] hover:bg-[#FFCACA] hover:text-black active:bg-[#372948] rounded-lg duration-150"
                        >
                            Create account
                        </button>
    ...
    {/* <div className="flex items-center justify-center bg-black h-[calc(100vh-10rem)]">
    <form>
        <input type="text" placeholder="Name" className="block py-2 px-3 mb-4 w-full text-black"/>
        <input type="email" placeholder="Email" className="block py-2 px-3 mb-4 w-full text-black"/>
        <input type="password" placeholder="Password" className="block py-2 px-3 mb-4 w-full text-black"/>
        <input type="password" placeholder="Confirm Password" className="block py-2 px-3 mb-4 w-full text-black"/>
